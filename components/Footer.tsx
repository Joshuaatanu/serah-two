...
function Footer() {
  return (
    <footer className="bg-[#c4c4c4] mt-20 py-10">
    ...
    <div className="flex flex-row justify-center space-x-4 mt-14">
      ...
      <img src="../public/images/twitter.svg" height="27px" width="24px" alt="" />
      <img src="../public/images/instagram.svg" height="27px" width="24px" alt="" />
      <img src="../public/images/facebook.svg" height="27px" width="24px" alt="" />
      <img src="../public/images/github.svg" height="27px" width="24px" alt="" />
    </div>
    <h5
